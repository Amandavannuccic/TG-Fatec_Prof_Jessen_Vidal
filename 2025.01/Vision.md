...
|-------------------------------|-------------------------|------------------------------------------------------------------------------|
| **Design de Interface**       | Figma                   | Ferramenta para criação de protótipos, wireframes e interfaces visuais.      |
| **Linguagem de Programação**  | Java                    | Linguagem orientada a objetos usada no desenvolvimento backend.              |
| **Gerenciamento de Projetos** | Jira                    | Plataforma ágil utilizada para planejamento, acompanhamento e organização das tarefas. |
| **Testes de API**             | Postman                 | Ferramenta usada para testar, validar e documentar APIs.                     |
| **Linguagem de Marcação**     | HTML                    | Linguagem base usada para estruturar páginas web.                            |
| **Linguagem de Programação**  | JavaScript              | Linguagem usada para adicionar dinamismo e interatividade às páginas web.    |
| **Framework Front-End**       | Vue.js                  | Framework JavaScript para construção de interfaces reativas.                 |
| **Framework Backend**         | Spring Boot             | Framework Java para criação de APIs e serviços de forma rápida e estruturada. |
| **Banco de Dados**            | PostgreSQL              | Sistema de banco de dados relacional robusto e open source.                  |
| **Conteinerização**           | Docker                  | Plataforma utilizada para criar e gerenciar contêineres de aplicações.       |
| **Qualidade de Código**       | SonarQube               | Ferramenta para análise contínua da qualidade do código.                     |
| **Linguagem Tipada**          | TypeScript              | Superset do JavaScript que adiciona tipagem estática e maior segurança.       |
| **Comunicação**               | Discord                 | Canal de comunicação utilizado para alinhamento e colaboração da equipe.      |
| **Comunicação / Colaboração** | Microsoft Teams         | Plataforma integrada para comunicação, reuniões online e organização da equipe. |
| **Editor de Código**          | VSCode                  | Editor utilizado para desenvolvimento, organização e depuração do projeto.   |
